...
public class TopRateAdapter extends RecyclerView.Adapter<TopRateAdapter.MovieViewHolder>{
    private List<ResultsItem> movies;
    private int rowLayout;
    private Context context;

    public TopRateAdapter(List<ResultsItem> movies, int rowLayout, Context context) {
        this.movies = movies;
    ...
    @Override
    public TopRateAdapter.MovieViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(TopRateAdapter.MovieViewHolder holder, int position) {
