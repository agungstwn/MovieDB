...
public class UpComingAdapter extends RecyclerView.Adapter<UpComingAdapter.MovieViewHolder>{
    ...
    public UpComingAdapter(List<ResultsItem> movies, int rowLayout, Context context) {
        this.movies = movies;
    ...
    @Override
    public UpComingAdapter.MovieViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(UpComingAdapter.MovieViewHolder holder, int position) {
