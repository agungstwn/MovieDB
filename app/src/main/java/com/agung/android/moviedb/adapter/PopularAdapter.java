...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.MovieViewHolder> {
    ...
    public PopularAdapter(List<ResultsItem> movies, int rowLayout, Context context) {
        this.movies = movies;
    ...
    @Override
    public void onBindViewHolder(PopularAdapter.MovieViewHolder holder, int position) {
